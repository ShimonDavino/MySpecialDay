...
<body>
  ...
  <li ><a href="#">גירסה 1.0.1</a></li>
      ...
      <button type="button" class="btn btn-default navbar-btn  navbar-left btn-xs btn-primary"  >כניסה</button>--%>
                    <ul class="nav navbar-nav navbar-left" dir="rtl" id="menu_items2">
                    <li>
                        <asp:Button class="btn btn-default navbar-btn  btn-inverse  navbar-left  btn-xs" ID="exitButton" runat="server" Visible="false" Text="יציאה" OnClick="exitButton_Click" /></li>
                    <li>
                ...
                <div class="col-sm-4">
                    ...
                    <table border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox CssClass="textboxCss" ID="datepicker" runat="server"></asp:TextBox>&nbsp;
                            </td>
                        </tr>
