...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <section id="prodacts" class="row">
                ...
                <div class="col-sm-4">
                    ...
                    <br />
                    <asp:Label ID="msgLabel" runat="server" Font-Bold="True" ForeColor="Maroon"></asp:Label>  <%--error msg--%>
                    <table border="0">
                        <tr>
                            <td>סוג האירוע:</td>
                            <td>
                        ...
                        <tr>
                          ...
                          <%--  <asp:Label ID="msgLabel1" runat="server" Font-Bold="True" ForeColor="Maroon"></asp:Label>  <%--error msg--%>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox CssClass="textboxCss" ID="PhoneOf_EventPlaceTextBox" runat="server"></asp:TextBox>
                                <%--<asp:Label ID="msgLabel2" runat="server" Font-Bold="True" ForeColor="Maroon"></asp:Label>  <%--error msg--%>
                            </td>
                        </tr>
                        <tr>
                            <td></td>
