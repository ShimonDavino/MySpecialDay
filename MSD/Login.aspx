<%@ Page Title="Log in" Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="MSD.Login" %>
 ...
 <%-- <li class="navbar-right"> <a href="ProductsForm.aspx">מוצרים</a></li>--%>
  ...
  <li ><a href="#">גירסה 1.0.1</a></li>
   ...
   <ul class="nav navbar-nav"> 
      ...
      <%--<button type="button" class="btn btn-default navbar-btn  btn-inverse  navbar-left  btn-xs" id="registerButton"><a href="Account/Register.aspx">רישום</a></button>--%>
