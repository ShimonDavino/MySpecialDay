<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="eventProfile_shaul.aspx.cs" Inherits="MSD.eventProfile_shaul" %>
...
<%-- <---------------- end of the headline --%>
        <br />
         <p class="text_3D" align="center" dir="rtl">ברוך הבא לדף האירוע שלך :   
             <asp:Label ID="EventOwnerNameLable" runat="server" Text=""></asp:Label>
         </p>
        
        <section id="prodacts"  class="row">
            <div class="col-sm-4">
                <asp:ImageButton ID="ImgLink" width="250" height="250" src="Content/images/mi-ba_4.jpg" alt="לחץ כאן לאשר את הגעתך לאירוע..." class="img-thumbnail img-responsive" runat="server" OnClick="confirmArrivalImageButton_Click" />
            ...
            <asp:TextBox ID="TextBox1" runat="server" BorderStyle="Dashed" BackColor="White" TextMode="MultiLine" ReadOnly="True" Height="200px" Width="300px"></asp:TextBox>
            </div>
           ...
           <div class="row">
            ...
            <div class="col-sm-4">
                ...
                <asp:TextBox ID="TextBox2" runat="server" BorderStyle="Dashed" BackColor="White" TextMode="MultiLine" ReadOnly="True" Height="200px" Width="300px"></asp:TextBox>
            </div>
